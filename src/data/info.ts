...
export const infoData: Record<string, InfoContent> = {
  ...
  'about': {
    ...
    content: `Founded in 2023, Nasseg was born from a desire to create a wardrobe that transcends trends. We believe in the power of simplicity and the enduring value of exceptional craftsmanship.
  ...
  'careers': {
    title: 'Careers',
    subtitle: 'Join the Nasseg family',
    image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&h=600&fit=crop',
    content: `At Nasseg, we are always looking for passionate and talented individuals to join our growing team. We foster a culture of creativity, excellence, and collaboration.
    
      ### Current Openings
      - **Senior Womenswear Designer** (New York)
      - **E-commerce Manager** (London)
      - **Client Advisor** (Paris)
      
      To apply, please send your CV and portfolio to careers@nasseg.com.`
  },
  'press': {
    title: 'Press',
    subtitle: 'Nasseg in the media',
    image: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=1200&h=600&fit=crop',
    content: `For all press inquiries, sample requests, and brand partnerships, please contact our PR team.
    
      ### Press Contact
      - **Email**: press@nasseg.com
      - **Phone**: +1 (800) NASSEG-PR
      
      Our latest lookbooks, high-resolution imagery, and brand guidelines are available upon request.`
  },
  'stockists': {
    title: 'Stockists',
    subtitle: 'Where to find us',
    image: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=1200&h=600&fit=crop',
    content: `Experience Nasseg in person at our flagship locations and select luxury retail partners worldwide.
    
      ### Flagship Stores
      - **New York**: 124 Madison Avenue
      - **London**: 45 Mount Street
      - **Paris**: 22 Rue Saint-Honoré
  ...
  'cookies': {
    ...
    image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&h=600&fit=crop',
    content: `Nasseg uses cookies to enhance your browsing experience, serve personalized ads or content, and analyze our traffic.
    
      ### What are Cookies?
      Cookies are small text files stored on your device that help us remember your preferences and understand how you interact with our website.
      
      ### Managing Preferences
      You can choose to accept or decline cookies through your browser settings. Please note that declining cookies may affect the functionality of our website.`
  }
};
