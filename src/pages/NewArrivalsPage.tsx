...
const NewArrivalsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f9f8f5]">
      ...
      <ScrollReveal variant="fade-down" className="relative h-[300px] md:h-[420px] -mt-[64px] overflow-hidden">
        <img
      ...
      <ScrollReveal variant="fade-up" className="max-w-8xl mx-auto px-5 lg:px-12 pb-16 lg:pb-24">
        {loading ? (
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 stagger-grid">
