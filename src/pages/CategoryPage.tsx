...
const CategoryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f9f8f5]">
      ...
      <Header backLabel="Back to Home" backTo="/" overlay={true} />

      <ScrollReveal variant="fade-down" className="relative h-[300px] md:h-[400px] -mt-[64px] overflow-hidden">
        <img
          src={meta.heroImage}
          alt={meta.title}
      ...
      {/* Product List/Grid */}
      <ScrollReveal variant="fade-up" className="max-w-8xl mx-auto px-5 lg:px-12 pb-16 lg:pb-24">
        {/* Loading skeletons */}
        ...
        {/* Products */}
        {!loading && !error && (
          <div className={viewMode === 'grid' ? "grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 stagger-grid" : "flex flex-col gap-2"}>
