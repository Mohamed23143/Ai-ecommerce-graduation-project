...
const CollectionCard = ({ collection, index }: { collection: Collection; index: number }) => {
  ...
  return (
    <ScrollReveal variant="fade-up" delay={index * 0.1} className="h-full block">
      <Link
        to={linkTo}
        className="group relative overflow-hidden h-[300px] md:h-[380px] cursor-pointer block"
      >
      {imgFailed ? (
...
const CollectionsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f9f8f5]">
      ...
      {/* Hero */}
      <ScrollReveal variant="fade-down" className="py-16 md:py-24 text-center">
