    ...
    <section id="brand-story" className="relative bg-dark text-white overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px]">
        ...
        <div className="flex flex-col justify-center px-5 lg:px-16 py-14 lg:py-20">
          ...
          {/* Stats */}
          <div className="flex items-center gap-8 lg:gap-12 mb-12">
            {stats.map((stat) => (
              <div key={stat.label}>
          ...
          <Link
            to="/about"
            className="w-fit bg-white text-dark text-[11px] font-sans tracking-widest-xl uppercase px-8 py-4 hover:bg-gold hover:text-white transition-all duration-300"
          >
            Learn More About Us
          </Link>
        </div>
