      ...
      <div className="max-w-8xl mx-auto px-5 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
          ...
          <ScrollReveal variant="fade-right" delay={0}>
            <Link
              to="/category/women"
              className="group relative overflow-hidden block h-[350px] md:h-[500px] cursor-pointer"
            >
            <img
          ...
          <ScrollReveal variant="fade-right" delay={0.2}>
            <Link
              ...
              className="group relative overflow-hidden block h-[280px] md:h-[350px] cursor-pointer"
            >
            <img
