        ...
        <div className="max-w-xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#trending"
              id="hero-explore"
              className="bg-white text-dark text-[11px] font-sans tracking-widest-xl uppercase py-3.5 px-8 hover:bg-gold hover:text-white transition-all duration-400 cursor-pointer"
            >
              Explore
            </a>
          </div>
